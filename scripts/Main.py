...
class Main:
    ...
    def main(self):
        ...
        package_file_path = '../backend/package.json'
        ...
        with open(package_file_path, 'w', encoding='utf-8') as package_file:
            package_file.write(dbconfig.generate_package(self))
            print(f"Archivo package.json generado en: {package_file_path}")
